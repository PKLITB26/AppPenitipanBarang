...
export default function EditPelangganScreen() {
  ...
  const handleSave = async () => {
    ...
    setIsLoading(true);
    try {
      await apiService.updatePelanggan(token, pelangganId, formData);
      ...
      Alert.alert('Error', error.message || 'Gagal mengupdate data pelanggan');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.formContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.avatarSection}>
          ...
          <Text style={styles.avatarText}>Edit Data Pelanggan</Text>
        </View>
      ...
      <View style={styles.buttonContainer}>
        ...
        >
          {isLoading ? (
            ...
            <Text style={styles.saveButtonText}>Update Pelanggan</Text>
          )}
        </TouchableOpacity>
